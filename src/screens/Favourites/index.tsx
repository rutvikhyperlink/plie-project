...
const Favourites = () => {
  const token: any = '148|QwsMFixT9w9MgleAbukZtghUuKNZGxgR1SYDOVMk';
...
console.log("favouriteEvents type of",typeof favouriteEvents);
console.log("favouriteEvents",favouriteEvents);


useEffect(() => {
  setEvents(favouriteEvents);
}, [favouriteEvents]);
    ...
    <View style={{ flex: 1, backgroundColor: '#F2F2F2' }}>
      ...
      {events.length == 0 ? (
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <EventCard item={item} onToggleLike={() => dispatch({ type: reducerType.removeFromFavourite, data: item })} />
          )}
